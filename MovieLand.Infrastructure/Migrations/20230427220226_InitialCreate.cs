        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("id", x => x.Id);
                    table.ForeignKey(
                        name: "FK_shopping_cart_item_movie_movie_id",
                        column: x => x.movie_id,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_movie_category_id",
                schema: "dbo",
                table: "movie",
                column: "category_id");

            migrationBuilder.CreateIndex(
                name: "IX_movie_price_id",
                schema: "dbo",
                table: "movie",
                column: "price_id",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_shopping_cart_item_movie_id",
                schema: "dbo",
